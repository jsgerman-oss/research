...
$89\%$ savings versus opus-default on the current trace (estimated from
published token-rate profiles; see \cref{sec:repro}).
%% TODO(baselines): fill Y% (vs static-frontmatter) and Z% (vs epsilon-greedy)
%% once doubly-robust off-policy evaluation is complete against the full trace.
%% Blocked on: data/raw/eval-fixtures.jsonl (MOA-11) and moa1b-prior.csv.
