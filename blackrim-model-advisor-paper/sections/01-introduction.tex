...
\begin{itemize}[leftmargin=*]
  \item \textbf{Problem formulation} (\cref{sec:problem}). We formalise
        ...
        $\tolerance \in [0,1]$ partitioned into four operational tiers
        (Critical $\tolerance = 0$, Strict $\tolerance < 0.02$, Moderate
        $\tolerance < 0.05$, Lenient $\tolerance < 0.10$).
  \item \textbf{Algorithm} (\cref{sec:algorithm}). We propose Conservative
        ...
        is committed with credible quality risk above $\tolerance$.
