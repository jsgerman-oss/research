...
gate-disabled variant lands at $-3.12\,\mathrm{pp}$ regression (i.e.\ a
...
empirical mean clears $\tau$) and pure-mean exploitation (cheapest tier
whose mean equals the per-cell maximum). The latter is not symmetric to
...
dominance over every gate-disabled variant.
