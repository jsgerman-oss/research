...
The held-out eval suite emits a three-level judge verdict $\{\mathrm{pass},
\mathrm{fail}, \mathrm{partial}\}$; we conservatively map $\mathrm{partial}
\to 0$, yielding a Bernoulli indicator that under-counts marginal
successes. In the data underpinning \cref{sec:eval}, $1$ of $96$ fixture
verdicts is partial; the conservative mapping does not materially affect
the reported pass rates.
