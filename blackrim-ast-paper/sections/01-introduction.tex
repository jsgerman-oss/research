...
\begin{itemize}[leftmargin=*]
  ...
  \item \textbf{Empirical evaluation} (\cref{sec:eval}). We report
        cross-language compression ratios on a 40-file polyglot
        corpus (10 files per language; Go 76--1098~LoC,
        Python 68--370~LoC, JavaScript 60--125~LoC,
        TypeScript 58--248~LoC;
        mean token savings: Go 65.2\%, Python 72.3\%,
        JavaScript 78.1\%, TypeScript 75.7\%) and a pre-registered
        empirical programme for the five further claims listed in
        \cref{sec:stance}.
\end{itemize}
